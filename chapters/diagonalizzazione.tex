...
\begin{proof}
	...
	Allora
	\begin{equation*}
		\chi_T(x) = \chi_{\overline{T}}(x)(x-a_{mm}),
	\end{equation*}
	...
	\begin{equation*}
		\begin{split}
			...
			&=\chi_{\overline{T}}(T)T(e_m)-a_{mm}\chi_{\overline{T}}(T)(e_m)=\\
			&=\chi_{\overline{T}}(T)\Big(\sum_{i=1}^ma_{im}e_i\Big)-a_{mm}\chi_{\overline{T}}(T)(e_m)=\\
			&=\sum_{i=1}^ma_{im}\chi_{\overline{T}}(T)(e_i)-a_{mm}\chi_{\overline{T}}(T)(e_m)=\\
			&=a_{mm}\chi_{\overline{T}}(T)(e_m)-a_{mm}\chi_{\overline{T}}(T)(e_m)=0
		\end{split}
	\end{equation*}
